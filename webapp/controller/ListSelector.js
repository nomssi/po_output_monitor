sap.ui.define([
		...
		return BaseObject.extend("poom.model.ListSelector", {
			 ...
			 * @return {poom.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
