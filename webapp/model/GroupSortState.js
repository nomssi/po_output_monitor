sap.ui.define([
	...
	return BaseObject.extend("poom.model.GroupSortState", {
		 ...
		 * @alias poom.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "CreationDate");
			}
